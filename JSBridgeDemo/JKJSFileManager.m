...
//  Teacher
//
//  Created by DingXiao on 2017/1/19.
//  Copyright © 2017年 Fclassroom. All rights reserved.
//

#import "JKJSFileManager.h"

@implementation JKJSFileManager
...
{
    return [[JKJSFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[JKJSFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[JKJSFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[JKJSFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[JKJSFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[JKJSFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
